...
const SEM_COLORS = {
  3: '#6366f1', 4: '#f59e0b', 5: '#10b981',
  6: '#ec4899', 7: '#3b82f6', 8: '#8b5cf6',
};
...
export default function SubjectsPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader
        title="Subjects"
        subtitle="CSE curriculum — Sem 3 to Sem 8"
      />
      ...
      <div className="relative max-w-md">
        ...
        <input value={search} onChange={e => setSearch(e.target.value)}
          placeholder="Search subjects..." className="input-field pl-10" />
      </div>
      ...
      <div className="flex items-center gap-3">
        <div className="w-1 h-6 rounded-full" style={{ background: SEM_COLORS[activeSem] }} />
              ...
              <Link to={`/subjects/${subject._id}`}
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-xs font-mono px-2 py-0.5 rounded-lg mt-0.5 inline-block"
                        style={{ background: `${subject.color}20`, color: subject.color }}>
                        {subject.code}
                      </span>
                    </div>
                  </div>
                  <ArrowRight size={16} className="mt-1 opacity-0 group-hover:opacity-100
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-xs" style={{ color: 'var(--color-text-muted)' }}>
                      {Math.max(...subject.topics.map(t => t.importanceScore), 0)} max
                    </span>
                  </div>
                ...
                <div className="space-y-2">
                  {subject.topics.slice(0, 3).map(topic => (
                    <div key={topic.name} className="flex items-center gap-2">
                      ...
                      <div className="w-16">
                        <ProgressBar value={topic.importanceScore} color={subject.color}
